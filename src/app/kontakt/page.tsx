            ...
            <div className="flex flex-col gap-12">
              ...
              >
                <div className="flex items-center justify-between mb-8">
                  <h1 className="text-7xl font-bold text-red-600">Sanierung</h1>
                  <div className="bg-red-600 p-6 rounded-xl shadow-lg">
                    <Image
                      src="/5__msi___png.webp"
                      alt="Sanierung Icon"
                      width={100}
                      height={100}
                ...
                <p className="text-2xl text-gray-700 mb-8">
                  Energie sparen durch zukunftsfähige Sanierung.
                </p>
              </motion.div>
              ...
              >
                <div className="md:w-1/2">
                  <Image
                    src="/undraw_sweet_home_dkhr.svg"
                ...
                <div className="md:w-1/2">
                  ...
                  <p className="text-xl text-gray-600 leading-relaxed">
                    Für die Sanierung von Wohngebäuden gibt es in Österreich viele Fördermöglichkeiten. Dadurch profitieren Sie doppelt: Ihr thermisch saniertes Gebäude benötigt in Zukunft weniger Energie fürs Heizen oder Kühlen – und Sie erhalten Unterstützung bei der Umsetzung. Förderungen sind auch für die Schaffung von Barrierefreiheit und Modernisierungen möglich. Wir beraten Sie zur optimalen Vorgehensweise und zu Förderungen für Ihr Sanierungsprojekt.
                  </p>
                </div>
              </motion.div>
            </div>
