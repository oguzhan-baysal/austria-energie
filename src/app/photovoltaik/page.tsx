                        ...
                        <div className="flex flex-col gap-12">
                            ...
                            >
                                <div className="flex items-center justify-between mb-8">
                                    <h1 className="text-7xl font-bold text-red-600">Photovoltaik</h1>
                                    <div className="bg-red-600 p-6 rounded-xl shadow-lg">
                                        <Image
                                            src="/6__msi___png.webp"
                                            alt="Photovoltaik Icon"
                                            width={100}
                                            height={100}
                            ...
                            >
                                <div className="md:w-1/2">
                                    <Image
                                        src="/undraw_control_panel_re_y3ar.svg"
                                        alt="Solarstrom Illustration"
                                        width={500}
                                        height={500}
                                        className="object-contain"
                                    />
                                ...
                                <div className="md:w-1/2">
                                    <h2 className="text-4xl font-bold text-gray-800 mb-6">
                                        Solarstrom nutzen – wir beraten Sie
                                    </h2>
                                    <h3 className="text-xl font-bold text-red-600 mb-6">
                                        IHRE OPTIMIERTE ZUKUNFT
                                    </h3>
                                    <p className="text-xl text-gray-600 leading-relaxed">
                                        Mit Ihrer Photovoltaik-Anlage stellen Sie Strom ohne CO2-Ausstoß selbst her.
                                        Damit der Bau eines PV-Systems leichter möglich ist, gibt es in Österreich
                                        eine Vielzahl von Fördermöglichkeiten. Wir beraten Sie gerne zu den aktuellen
                                        Förderungen 2024, damit Ihr eigenes Kraftwerk auf dem Dach oder den
                                        Außenanlagen bald Realität wird.
                                    </p>
                                </div>
                            </motion.div>
                        </div>
                    ...
                    <div className="container mx-auto px-4">
                        ...
                        >
                            ...
                            <h3 className="text-4xl font-bold mb-8">
                                Förderungen für die Errichtung von Photovoltaik-Anlagen
                            </h3>
                            <p className="text-xl leading-relaxed">
                                Die Förderwelt in Österreich stützt sich auf drei Prinzipien:
                                Sie können finanzielle Zuschüsse beantragen, zinsgünstige Kredite erhalten
                                oder von steuerlichen Vergünstigungen profitieren. Unser Team begleitet Sie
                                durch den Förderungsdschungel und berät Sie zu den aktuellen Möglichkeiten
                                für Ihr Zuhause oder Ihren Betrieb. Wir unterstützen Sie bei der Wahl und
                                beim Beantragen von Förderungen für Ihr privates oder betriebliches
