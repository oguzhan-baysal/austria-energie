            ...
            <div className="flex flex-col gap-12">
              ...
              >
                <div className="flex items-center justify-between mb-8">
                  <h1 className="text-7xl font-bold text-red-600">Team</h1>
                  <div className="bg-red-600 p-6 rounded-xl shadow-lg">
                    <Image
                      src="/6__msi___png (1).webp"
                      alt="Sanierung Icon"
                      width={100}
                      height={100}
                ...
                <p className="text-2xl text-gray-700 mb-8">
                  Unser erfahrenes und freundliches Team stellt sich vor.
                </p>
              </motion.div>
              ...
              >
                ...
                <div className="md:w-1/2">
                  <h2 className="text-4xl font-bold text-gray-800 mb-6">
                    Energieberatung – unser Team ist in Österreich für Ihre Fragen da!
                  </h2>
                  <h3 className="text-xl font-bold text-red-600 mb-6">
                    IHRE OPTIMIERTE ZUKUNFT
                  </h3>
                  <p className="text-xl text-gray-600 leading-relaxed">
                    Erfahrung und aktuelles Fachwissen setzen wir ein, um für Sie die optimale Beratung zu ermöglichen. Wir gehen freundlich und genau auf alle Ihre Fragen ein und nehmen wichtige Daten auf, die es uns ermöglichen, den Ist-Zustand zu analysieren. Unser Team erstellt dann eine klare Analyse für Sie, die bei Bedarf auch bereits Umsetzungsoptionen enthält.
                  </p>
                </div>
              </motion.div>
            </div>
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <h3 className="text-4xl font-bold mb-8">
                Freundliche und kompetente Energieberatung
              </h3>
              <p className="text-xl leading-relaxed">
                Unser Fachwissen steht Ihnen zur Verfügung, wenn Sie sich für eine Energieberatung bei AUSTRIA Energie entscheiden. Unser kompetentes Team kennt sich aus, wenn es um optimale Energienutzung, Förderungen für Sanierungen und Modernisierungen sowie um Smart Home-Lösungen geht.



                Ziel ist es, den Energieverbrauch zu optimieren – durch Nutzung von Einsparungsoptionen, den Einsatz von hocheffizienten Heizsystemen bis hin zur energetischen Sanierung Ihres Eigenheims oder Unternehmensobjekts. Wir nehmen uns persönlich Zeit für Ihre Anliegen.
              </p>
            </motion.div>
          </div>
        </section>
