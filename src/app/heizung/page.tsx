                        ...
                        <div className="flex flex-col gap-12">
                            ...
                            >
                                <div className="flex items-center justify-between mb-8">
                                    <h1 className="text-7xl font-bold text-red-600">Heizung</h1>
                                    <div className="bg-red-600 p-6 rounded-xl shadow-lg">
                                        <Image
                                            src="/4__msi___png.webp"
                                            alt="Heizung Icon"
                                            width={100}
                                            height={100}
                                ...
                                <p className="text-2xl text-gray-700 mb-8">
                                    Perfekte Heizung für Kostenoptimierung und Klimaneutralität.
                                </p>
                            </motion.div>
                            ...
                            >
                                ...
                                <div className="md:w-1/2">
                                    <h2 className="text-4xl font-bold text-gray-800 mb-6">
                                        Ihr Partner für Heizungsberatung in Österreich
                                    </h2>
                                    <p className="text-xl text-gray-600 leading-relaxed">
                                        Ein Heizungstausch kann eine Investition in die Zukunft sein, für die Sie attraktive Förderungen bekommen können. Vor allem, wenn Sie sich für den Umstieg von Öl und Gas auf erneuerbare Energiequellen entscheiden, greifen Staat und Bundesländer Ihnen beim Tausch unter die Arme. Sie investieren in die Zukunft Ihrer Familie und die unseres Planeten. Nutzen Sie die Fördermöglichkeiten im Jahr 2024, wir beraten Sie dazu.
                                    </p>
                                </div>
                            </motion.div>
                        </div>
                    ...
                    <div className="container mx-auto px-4">
                        ...
                        >
                            ...
                            <p className="text-xl leading-relaxed">
                                Diese Förderung steht sowohl Privaten als auch Betrieben zur Verfügung.
                                Ziel ist es, den Umstieg von fossilen Brennstoffen auf hocheffiziente oder
                                klimafreundliche Heizsysteme zu erleichtern. Das Bundesministerium für
                                Klimaschutz, Umwelt, Energie, Mobilität, Innovation und Technologie (BMK)
                                unterstützt Sie dabei und setzt einen Schritt in Richtung Klimaneutralität
                                Österreichs. Die Mittel wurden für die Jahre 2024 bis 2026 aufgestockt.
                                Wir beraten Sie gerne zu optimalen Heizsystemen, die speziell für Ihre
                                Anforderungen passen und zur Nutzung der aktuell verfügbaren Förderungen.
                            </p>
                        </motion.div>
                    </div>
                </section>

                {/* Contact Section - Ana sayfadan */}
