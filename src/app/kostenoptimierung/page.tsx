...
export default function Kostenoptimierung() {
                        ...
                        <div className="flex flex-col gap-12">
                            ...
                            >
                                <div className="flex items-center justify-between mb-8">
                                    <h1 className="text-7xl font-bold text-red-600">Kostenoptimierung</h1>
                                    <div className="bg-red-600 p-6 rounded-xl shadow-lg">
                                        <Image
                                            src="/3__msi___png.webp"
                                            alt="Kostenoptimierung Icon"
                                            width={100}
                                            height={100}
                                ...
                                <p className="text-2xl text-gray-700 mb-8">
                                    Beratung zur Optimierung von Energiekosten.
                                </p>
                            </motion.div>
                            ...
                            >
                                <div className="md:w-1/2">
                                    <Image
                                        src="/undraw_success_factors_re_ce93.svg"
                                        alt="Kostenoptimierung Illustration"
                                        width={500}
                                        height={500}
                                        className="object-contain"
                                    />
                                ...
                                <div className="md:w-1/2">
                                    <h2 className="text-4xl font-bold text-gray-800 mb-6">
                                        Energiekostenoptimierung – Beratung in Österreich
                                    </h2>
                                    <h3 className="text-xl font-bold text-red-600 mb-6">
                                        IHRE OPTIMIERTE ZUKUNFT
                                    </h3>
                                    <p className="text-xl text-gray-600 leading-relaxed">
                                        Durch Energiekostenoptimierung sparen Sie nicht nur Geld, denn effiziente Nutzung der Ressourcen schont auch die Umwelt. Wir beraten Sie zu Ihren Fragen rund um die Optimierung der Kosten für Energie, bei der Sie nicht auf Komfort verzichten müssen. Dabei beleuchten wir Fragen wie die effiziente Nutzung von Energie, Einsparungen durch Modernisierung und den Einsatz von Smart Home-Technologien.
                                    </p>
                                </div>
                            </motion.div>
                        </div>
                    ...
                    <div className="container mx-auto px-4">
                        ...
                        >
                            ...
                            <p className="text-xl leading-relaxed">
                                Nutzen Sie in Ihrem Zuhause einfach nur so viel Energie, wie Sie wirklich brauchen. Das ist durch intelligenten Umgang mit dem Energieverbrauch möglich, aber auch durch Smart Home-Lösungen. Denn damit steuern Sie Verbraucher wie die Heizung, Beschattung und mehr flexibel mit nur wenigen Klicks auch von unterwegs und können dadurch auf aktuell wechselnde Bedingungen reagieren.



                                Modernisierung und Sanierung können ein Schlüssel zum energieeffizienten Wohnen sein.

                                Wir beraten Sie und zeigen Ihnen attraktive, aktuelle Fördermöglichkeiten auf.
                            </p>
                        </motion.div>
                    </div>
                </section>
